...
- 原始内容：你好, systemMsg=null, model=deepseek-chat, url=https://api.deepseek.com/v1/chat/completions, apiKey=sk-43acb864f0604d23ae1329c14c1d1c0b, apiSecret=, source=openai, topK=4, maxTokens=2048, isThink=false, multiMode=false, modelEnabled=true, extraParams={temperature=1}, history=[])
2025-12-03 17:41:45.401 [workflow-1] INFO  c.i.a.w.e.i.model.OpenAiStyleLlmIntegration - OpenAI Style API URL: https://api.deepseek.com - /v1/chat/completions
2025-12-03 17:41:45.742 [ForkJoinPool.commonPool-worker-1] ERROR o.springframework.ai.chat.model.MessageAggregator - Aggregation Error
...
Error has been observed at the following site(s):
    *_______________Mono.then ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient.releaseIfNotConsumed(DefaultWebClient.java:197)
    *____________Mono.flatMap ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.applyStatusHandlers(DefaultWebClient.java:697)
    |_     Mono.onErrorResume ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.applyStatusHandlers(DefaultWebClient.java:698)
    |_           Mono.flatMap ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.applyStatusHandlers(DefaultWebClient.java:703)
    |_             checkpoint ⇢ 401 UNAUTHORIZED from POST https://api.deepseek.com/v1/chat/completions [DefaultWebClient]
    |_              Mono.flux ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.handleBodyFlux(DefaultWebClient.java:672)
    |_     Flux.switchIfEmpty ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.handleBodyFlux(DefaultWebClient.java:672)
    *_______________Mono.then ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient.releaseIfNotConsumed(DefaultWebClient.java:197)
    *________Mono.flatMapMany ⇢ at org.springframework.web.reactive.function.client.DefaultWebClient$DefaultResponseSpec.bodyToFlux(DefaultWebClient.java:596)
    |_         Flux.takeUntil ⇢ at org.springframework.ai.openai.api.OpenAiApi.chatCompletionStream(OpenAiApi.java:239)
    |_            Flux.filter ⇢ at org.springframework.ai.openai.api.OpenAiApi.chatCompletionStream(OpenAiApi.java:241)
- workflow Java版本的调试
